...
SMOKE_CONTRACTS: dict[str, SmokeContract] = {
    ...
    "ide-open": SmokeContract(
        profile="ide-open",
        mode="open",
        required=[
            ConditionSpec("process_count"),
            ConditionSpec("windows", "nonempty"),
            ConditionSpec("opened_target"),
        ],
        evidence_keys=["target", "family", "launcher_path", "window_name", "duration_seconds"],
    ),
    "ide-write": SmokeContract(
        profile="ide-write",
        mode="write",
        required=[
            ConditionSpec("opened_target"),
        ...
        evidence_keys=["target", "family", "launcher_path", "window_name", "marker", "duration_seconds"],
    ),
    "ide-workflow": SmokeContract(
        ...
        evidence_keys=[
            ...
            "required_steps_ok",
            "workflow_path_in_project",
            "workflow_symbol_name",
            "workflow_renamed_symbol",
            "symbol_info_ok",
            "rename_ok",
            "reformat_ok",
            "find_file_ok",
